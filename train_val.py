...
"""
assert type(config['num_of_epochs']) is int, 'Accepts an integer value for `num_of_epochs` parameter in config.py file'
assert type(config['max_length']) is int, 'Accepts an integer value for `max_length` parameter in config.py file'
assert type(config['batch_size']) is int, 'Accepts an integer value for `batch_size` parameter in config.py file'
assert type(config['beam_search_k']) is int, 'Accepts an integer value for `beam_search_k` parameter in config.py file'
assert type(config['random_seed']) is int, 'Accepts an integer value for `random_seed` parameter in config.py file'
assert type(rnnConfig['embedding_size']) is int, 'Accepts an integer value for `embedding_size` parameter in config.py file'
assert type(rnnConfig['LSTM_units']) is int, 'Accepts an integer value for `LSTM_units` parameter in config.py file'
assert type(rnnConfig['dense_units']) is int, 'Accepts an integer value for `dense_units` parameter in config.py file'
assert type(rnnConfig['dropout']) is float, 'Accepts a float value for `dropout` parameter in config.py file'
...
"""
    *Train the model and we save it after each epoch
"""
